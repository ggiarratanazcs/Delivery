                      ...
                      return (
                        <tr key={card.id} onClick={() => { setEditCard(card); setTargetColId(card.colonna_id); setShowCardModal(true); }}
                          ...
                          <td style={{ padding: '10px 14px', borderLeft: `3px solid ${col.colore}` }}>
                            ...
                            {card.rif_pratica && <div style={{ fontSize: 10, color: '#94a3b8', fontFamily: 'inherit', fontVariantNumeric: 'tabular-nums', marginTop: 2 }}>{card.rif_pratica}</div>}
                          </td>
                          ...
                          <td style={{ padding: '10px 14px', fontSize: 11, color: '#64748b', fontFamily: 'inherit', fontVariantNumeric: 'tabular-nums' }}>
                          ...
                          <td style={{ padding: '10px 14px', fontSize: 12, color: '#64748b', fontFamily: 'inherit', fontVariantNumeric: 'tabular-nums' }}>{card.stima_ore ? `${card.stima_ore}h` : '—'}</td>
                        </tr>
                      );
                    })}
                  </tbody>
